...
import val_add_eoir as validate  # for end-of-epoch mAP
from models.experimental import attempt_load
from models.yolo import Model
from utils.autoanchor import check_anchors_add_eoir as check_anchors
from utils.autobatch import check_train_batch_size
from utils.callbacks import Callbacks
from utils.dataloaders import create_dataloader_add_eoir, create_dataloader_rgb_ir_add_eoir
...
def train(hyp, opt, device, callbacks):  # hyp is path/to/hyp.yaml or hyp dictionary
    ...
    # Trainloader
    train_loader, dataset = create_dataloader_rgb_ir_add_eoir(train_path_rgb,
                                                    train_path_ir,
                                                    imgsz,
    ...
    # Process 0
    if RANK in {-1, 0}:
        val_loader_rgb = create_dataloader_add_eoir(val_path_rgb,
                                       imgsz,
        ...
        val_loader_ir = create_dataloader_add_eoir(val_path_ir,
                                       imgsz,
                                       batch_size // WORLD_SIZE * 2,
                                       gs,
                                       single_cls,
